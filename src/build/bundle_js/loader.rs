...
use swc_core::{
    ...
    bundler::{Load, ModuleData},
    common::{
        collections::AHashMap,
        comments::{NoopComments, SingleThreadedComments},
        errors::{Handler, HANDLER},
        sync::Lrc,
        FileName, Mark, SourceFile, DUMMY_SP,
    },
    ecma::{
        ast::{EsVersion, Expr, Lit, Module, Program, Str},
        parser::{parse_file_as_expr, parse_file_as_module, Syntax},
        transforms::{
            base::{helpers, helpers::Helpers, pass::noop, resolver},
            optimization::{
                inline_globals,
...
use super::jsx::jsx_dom_expressions;
...
fn load_json_as_module(fm: &Arc<SourceFile>) -> Result<Module, Error> {
